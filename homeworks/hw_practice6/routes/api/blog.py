...
class ArticleCategories(Resource):
    def get(self):
        ...
        articles_categories = {}
        for article in articles:
            articles_categories[article.title] = article.serialize

            if article.categories:
                categories = []
                for category in article.categories:
                    categories.append(category.title)
                articles_categories[article.title]['categories'] = categories
...
api.add_resource(ArticleCategories, '/api/categories_of_articles')
