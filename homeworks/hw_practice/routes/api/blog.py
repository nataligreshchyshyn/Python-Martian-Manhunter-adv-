...
class Contact(Resource):
    def post(self):
        data = request.json
        msg = Message('Contact form alert!', recipients=[Config.MAIL_USERNAME])
        msg.html = "Contact Email: " + data['email'] + "<br>" + "Contact Title: " + data[
            'title'] + "<br>" + "Contact Description: " + data['description']
        mail.send(msg)
        client_msg = Message('Dear Client!', recipients=[data['email']])
...
api.add_resource(FooterLink, '/api/footer-useful-links')
